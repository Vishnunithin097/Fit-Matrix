...
export default function Analytics() {
  return (
    <div className="page-stack">
      <section className="hero-panel compact"><div><p className="eyebrow">Performance analytics</p><h1 className="hero-title">Visualize your momentum with clarity.</h1></div></section>
      <motion.div className="chart-card" initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }}>
        <div className="panel-head"><h3>Weekly progress</h3><span className="panel-tag">Calories • Protein • Water</span></div>
        <div className="chart-area">
          <ResponsiveContainer width="100%" height={280}>
            <AreaChart data={data}>
              <defs><linearGradient id="colorCalories" x1="0" y1="0" x2="0" y2="1"><stop offset="5%" stopColor="#a855f7" stopOpacity={0.8} /><stop offset="95%" stopColor="#a855f7" stopOpacity={0.05} /></linearGradient></defs>
